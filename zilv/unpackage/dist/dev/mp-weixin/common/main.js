...
_requestMiniprogram.$http.afterRequest = function () {uni.hideLoading();};_vue.default.config.productionTip = false;_App.default.mpType = 'app';var app = new _vue.default(_objectSpread({},
_App.default));
